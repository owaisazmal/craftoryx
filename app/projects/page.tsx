    ...
    <section className="mb-12 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-lg p-8 sm:p-12 text-white shadow-xl">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <a
            href="/contact"
            className="bg-white text-blue-600 px-6 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors shadow-md flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            className="bg-white/10 backdrop-blur-sm border-2 border-white text-white px-6 py-4 rounded-lg font-semibold hover:bg-white/20 transition-colors flex items-center justify-center gap-2"
          >
